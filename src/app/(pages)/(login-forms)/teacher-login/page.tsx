        ...
        >
            <div className="backdrop-blur-xl font-bold text-black rounded-box w-xs hover:shadow-md shadow-sky-400">
                <fieldset className="fieldset p-5">
                    <legend className="fieldset-legend text-2xl">Teachers Login</legend>
                    ...
                    <Link href={"/teacher"} className="btn btn-outline btn-ghost mt-4  hover:shadow-md shadow-green-200">
                        Login
                    </Link>
                    ...
                    <div>
                        <div className="flex justify-center mt-4">
                            <Link href="/teacher-emailForm" className="link btn btn-link">
